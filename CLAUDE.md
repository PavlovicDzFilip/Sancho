...
- `sancho --agent <name>` — one-off agent override (default `claude`; `cursor` and `hermes` supported); persisted via `sancho config set agent <name>`
